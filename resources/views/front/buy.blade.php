...
@section('content')
    ...
    <!-- Modal -->
    <div id="payment_modal" class="modal" role="dialog">
    ...
    <script>
        (function ($) {
            ...
            function formatState(state) {
                ...
                console.log(image)
                var $state = $('<span><img src="{{ asset('assets/images/currency/')}}' + "/" + image + '" style="width: 30px;height: 20px;margin-right: 5px;">' + state.text + '</span>');
                return $state;
            }
        })(jQuery);
