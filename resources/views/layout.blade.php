...
<body>
    ...
    <header class="header navbar-fixed-top" style="background-color: #124f92;z-index: 5;">
        <div class="container">
            <div class="row d-flex">
                <div class="col-xl-4 mark col-md-12 col-xs-12" style="background-color: #fbfbfb00;">
                    <div class="logo">
                        <a href="{{url('/')}}" class="logo main-logo">
                            <p style="font-size:27px; color: #ffca2c;float: left;">{{ __('sentence.democoin')}}</p><p style="font-size:27px; float: left;color: white;">&nbsp;&nbsp;&nbsp; {{ __('sentence.exchange')}}</p>
                        </a>
                    </div>
                ...
                <div class="col-xl-8 d-flex align-items-center col-lg-12">
                    <div class="main-menu">
                        <ul>
    ...
    <!-- ////////////////////// -->
    <script src="{{asset('assets/public/assets/tether/tether.min.js')}}"></script>
    <script src="{{asset('assets/public/assets/smooth-scroll/smooth-scroll.js')}}"></script>
    <script src="{{asset('assets/public/assets/dropdown/js/script.min.js')}}"></script>
    <script src="{{asset('assets/public/assets/touch-swipe/jquery.touch-swipe.min.js')}}"></script>
    <script src="{{asset('assets/public/assets/viewport-checker/jquery.viewportchecker.js')}}"></script>
    <script src="{{asset('assets/public/assets/jarallax/jarallax.js')}}"></script>
    <script src="{{asset('assets/public/common-js/multislider.min.js')}}"></script>
    <script src="{{asset('assets/public/common-js/jquery.classycountdown.js')}}"></script>
    <script src="{{asset('assets/public/common-js/jquery.knob.js')}}"></script>
    <script src="{{asset('assets/public/common-js/jquery.throttle.js')}}"></script>
    <script src="{{asset('assets/public/common-js/scripts.js')}}"></script>
    <script src="{{asset('assets/public/common-js/Winwheel.js')}}"></script>
    <script src="{{asset('assets/public/common-js/d3.js')}}"></script>
                    ...
                    $(document).ready(function() {
                        Swal.fire({
                          ...
                          html:
                            ...
                            '<a href="{{route('depost')}}">Click Here</a> ' + 'to go to deposit page',
