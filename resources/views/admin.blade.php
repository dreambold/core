...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item @if(request()->path() == 'admin/shoes') active @endif" href="{{route('shoes.index')}}"><i class="app-menu__icon fa fa-exchange"></i><span class="app-menu__label">Manage Shoes</span></a>
        </li>
        <li>
            <a class="app-menu__item @if(request()->path() == 'admin/shoes/log/exchange') active @endif" href="{{route('shoes.log')}}"><i class="app-menu__icon fa fa-exchange"></i><span class="app-menu__label">Shoes Logs</span></a>
        </li>
        <li>
            <a class="app-menu__item @if(request()->path() == 'admin/shoes/buy/physical') active @endif" href="{{route('buy.shoe.physical.show')}}"><i class="app-menu__icon fa fa-exchange"></i><span class="app-menu__label">Confirm Shoes Purchases</span></a>
        </li>
