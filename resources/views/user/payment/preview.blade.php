                        ...
                        <form method="POST" action="{{route('deposit.confirm')}}">
                            ...
                            <div class="card text-center">
                                <ul class="list-group">
                                    ...
                                    <li style="background-color: #e8e8e8; font-size: 16px;" class="list-group-item pt-0 pb-0">
                                        Desposit of <strong>{{$data->currency->name}}</strong> via <strong>{{$data->gateway->name}}</strong>
                                    </li>
                                    ...
                                    <li class="list-group-item"> Payable in USD :
                                        <strong>${{$data->usd}}</strong>
                                    </li>

                                    <li class="list-group-item"> Total amount you will get :
                                        <strong>{{$data->amount + $data->discount}} {{ $basic->currency }}</strong>
                                    </li>
