                            ...
                            <form role="form" method="POST" action="{{route('currency.update',$currency)}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 text-center mt-3 mb-3">
                                        <span class="border-top my-3 border-bottom font-weight-bold"> Discount for Deposits </span>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <h5>Discount Fixed:</h5>
                                        <div class="input-group">
                                            <input type="text" name="discount_fixed" value="{{$currency->discount_fixed}}"
                                                   class="form-control form-control-lg"
                                                   onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                        </div>
                                        @if ($errors->has('discount_fixed'))
                                            <div class="error">{{ $errors->first('discount_fixed') }}</div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="discount_percentage" value="{{$currency->discount_percentage}}"
                                                   class="form-control form-control-lg"
                                                   onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                            <div class="input-group-append">
                                                <span
                                                    class="input-group-text"><strong>%</strong>
                                                </span>
                                            </div>
                                        </div>
                                        @if ($errors->has('discount_percentage'))
                                            <div class="error">{{ $errors->first('discount_percentage') }}</div>
                                        @endif
                                    </div>
                                </div>
